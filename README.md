...
## Responsive Design 📱
The layout was built with a mobile-first mindset to ensure adaptability across different screen sizes. <br/>
Flexbox and CSS Grid were used to create flexible layouts that maintain visual consistency and usability on both small and large devices .<br/>
Typography, spacing, and section alignment were carefully adjusted to improve readability and overall user experience .<br/>
...
## Project Structure ⚙️
Organized project structure focused on scalability and maintainability.<br/>
